function [ g_delay ] = GAUS1(Ak, Power, Delay, M, fm,T, NumSamples)
% Channel with GAUS1 Doppler spectrum
% Ak: Hardamard codes of k-th ta
% Power: channel power
...
beta = (pi/M) .* n;
alpha = 0;
theta = linspace(37*pi/180,41*pi/180,16);
